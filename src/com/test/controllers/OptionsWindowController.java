...
import com.test.views.ColourTheme;
import com.test.views.FontSize;
...
public class OptionsWindowController extends BaseController implements Initializable {
    ...
    @FXML
    private ChoiceBox<ColourTheme> themePicker;
    ...
    void applyButtonAction() {
        System.out.println("inside applybuttonaction");
    ...
    private void setUpThemePicker() {
        themePicker.setItems(FXCollections.observableArrayList(ColourTheme.values()));
